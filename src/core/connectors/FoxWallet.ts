...
export type FoxWalletConnectorOptions = {
  /**
...
export class FoxWalletConnector extends InjectedConnector {
  ...
  #UNSTABLE_shimOnConnectSelectAccount: FoxWalletConnectorOptions['UNSTABLE_shimOnConnectSelectAccount'];
  ...
  constructor({
    ...
    chains?: Chain[];
    options?: FoxWalletConnectorOptions;
  } = {}) {
    const options = {
      name: 'FoxWallet',
      shimDisconnect: true,
