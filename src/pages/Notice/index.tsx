      ...
      <Fancybox className="flex flex-column flex-fill justify-content-center py-5 bg-primary-tertiary">
        <div className="container fs-20 text-primary-dark">
          ...
          <div className="mb-5">
            ...
            <p>快捷提币入口：<a href="https://cf-ipfs.com/ipfs/bafybeieac5ahoy2z3buevdymdwwed3pyk3qly4uxhiepwl453ommsyztpq" target="_blank" rel="noreferrer">https://cf-ipfs.com/ipfs/bafybeieac5ahoy2z3buevdymdwwed3pyk3qly4uxhiepwl453ommsyztpq</a></p>
