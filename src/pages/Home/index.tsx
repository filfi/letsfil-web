    ...
    <>
            ...
            <div className="col">
              <p className="mb-4">
                <span className="badge badge-primary ps-1">
                  ...
                  <span className="ms-2">创新的“募集计划”让投资人和SP重建信任</span>
                </span>
              </p>
      ...
      <section className={classNames(styles.section, styles.grid)}>
        <div className="container text-center">
          <div className="mb-5">
            <h3 className={classNames('mb-3 fw-600', styles.title)}>为投资人而生</h3>
            <p className={classNames('text-gray-dark', styles.summary)}>守望投资人，重构存储节点联合建设规则，安全是一切收益之源</p>
          </div>
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p>投资100%流入智能合约，看得见每个FIL的投资去向，查得到每笔收益的分配记录，杜绝一切黑箱操作。</p>
                </div>
              </div>
            </div>
            <div className="col">
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <h4 className="card-title">对投资人完全免费</h4>
                  <p>投资人100%获得募集计划承诺的分成比例，FilFi不会向投资人收取任何费用，也不会分享投资人的收益。</p>
                </div>
              </div>
            </div>
            <div className="col">
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p>可选技术服务商经过社区严格的KYC，创新的“技术运维保证金”制度，确保技术服务商相关利益不低于10%，与投资人利益全周期绑定。</p>
                </div>
              </div>
            </div>
          </div>
