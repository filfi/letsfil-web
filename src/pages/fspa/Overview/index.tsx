    ...
    <>
      ...
      <section className={styles.main}>
        <div className="container">
          <LoadingView className="vh-50" data={provider} error={info.isError} loading={info.isLoading} retry={info.refetch}>
            ...
            <div className="row g-3 g-lg-4 g-xl-5 mb-5">
              <div className={classNames('col-12 col-lg-8', showExtra ? 'col-xl-9' : 'col-xl-10 offset-md-2 offset-xl-1')}>
                ...
                <div className="d-flex flex-wrap gap-3 gap-xl-5 mb-5">
                  <div className="fs-sm">
                    <p className="mb-1 text-neutral">
                      ...
                      <span className="ms-1">个</span>
                    </p>
                    <p className="mb-1 text-gray">社区验证节点</p>
                  </div>
                  <div className="fs-sm">
                    <p className="mb-1 text-neutral">
                    ...
                    <p className="mb-1 text-gray">FilFi联合节点</p>
                  </div>
                  <div className="fs-sm">
                    <p className="mb-1 text-neutral">
                    ...
                    <p className="mb-1 text-gray">联合节点规模</p>
                  </div>
                  <div className="fs-sm">
                    <p className="mb-1 text-neutral">
                      <span className="fs-20 fw-600 text-main">{formatNum(toNumber(provider?.union_node_reward), '0.0A')}</span>
                      <span className="ms-1">FIL</span>
                    </p>
                    <p className="mb-1 text-gray">累计分配</p>
                  </div>
                  <div className="fs-sm">
                    <p className="mb-1 text-neutral">
                    ...
                    <p className="mb-1 text-gray">共分配给</p>
                  </div>
                </div>

                <div className="mb-5">
                  <h4 className="fs-18 fw-600">签名地址</h4>
                  <p className="text-gray">签名地址是技术服务商在FilFi网络中提供服务的唯一标识。</p>
                ...
                <div className="mb-5">
                  <h4 className="fs-18 fw-600">运维节点</h4>
                  <p className="text-gray">SP运维的Filecoin节点，基于FilFi协议建设或者通过了FilFi社区验证。</p>

                  <LoadingView className="my-5" data={nodes.data} error={nodes.isError} loading={nodes.isLoading} retry={nodes.refetch}>
                ...
                <div className="col-12 col-lg-4 col-xl-3">
                  ...
                  {links && (
                    <p className="hstack flex-wrap gap-3 text-gray fs-lg mb-5">
                      {links.map((item, idx) => (
                        <a key={idx} className="text-reset" href={item.url} title={item.name} target="_blank" rel="noreferrer">
